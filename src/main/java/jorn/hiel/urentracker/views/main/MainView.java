package jorn.hiel.urentracker.views.main;
...
import jorn.hiel.urentracker.views.yearoverview.YearOverviewView;
 ...
 */
@PWA(name = "UrenTrackerV2", shortName = "UrenTrackerV2", enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "UrenTrackerV2 logo"));
        logoLayout.add(new H1("UrenTrackerV2"));
